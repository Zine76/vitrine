    ...
    try {
        ...
        function startStatusEventSource() {
            ...
            window.showTypingIndicator = function(sender = 'sea') {
                ...
                // 🎨 Texte simple minimaliste
                const senderText = sender === 'sea' ? 'Technicien' : 'Client';
                
                // Créer nouvel indicateur SIMPLE
                const indicator = document.createElement('div');
                indicator.id = 'typing-indicator-vitrine';
                indicator.innerHTML = `
                    <div style="padding: 8px 15px; margin: 5px 0; font-size: 13px; color: #6b7280; font-style: italic;">
                        <span style="font-weight: 600; color: #059669;">${senderText}</span>
                        <span style="opacity: 0.8;">est en train d'écrire</span>
                        <span style="display: inline-flex; gap: 2px; margin-left: 4px;">
                            <span style="width: 4px; height: 4px; background: #6b7280; border-radius: 50%; display: inline-block; animation: typingDot 1.4s infinite;"></span>
                            <span style="width: 4px; height: 4px; background: #6b7280; border-radius: 50%; display: inline-block; animation: typingDot 1.4s infinite; animation-delay: 0.2s;"></span>
                            <span style="width: 4px; height: 4px; background: #6b7280; border-radius: 50%; display: inline-block; animation: typingDot 1.4s infinite; animation-delay: 0.4s;"></span>
                        </span>
                    </div>
                `;
