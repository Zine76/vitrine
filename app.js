// === Extracted from vitrine-lock-integrated-LOCKED-FINAL.html ===
// All application logic is here; early-lock + api-patch remain inline in HTML.
(function () {
...
// ===== CONFIGURATION =====
        ...
        async function closeChat() {
            try {
                ...
                if (currentChatId) {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/tickets/chat/end`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
        ...
        async function acceptChat() {
            try {
                ...
                const response = await fetch('/api/tickets/chat/consent', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function sendChatMessage() {
            ...
            try {
                ...
                const response = await fetch('/api/tickets/chat/message', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        function startStatusEventSource() {
            ...
            // Créer un nouvel EventSource pour les changements de statut
            const sseUrl = `${API_BASE_URL}/api/tickets/chat/events/vitrine?room_id=${currentRoom}`;
        ...
        async function submitTechnicalAuth() {
            ...
            try {
                const response = await fetch('/api/technical/auth', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
