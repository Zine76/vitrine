    ...
    try {
        ...
        function openChatInterface() {
            ...
            if (messagesContainer && messagesContainer.children.length === 0) {
                // Ajouter le message d'accueil standard
            const welcomeMessage = document.createElement('div');
            welcomeMessage.className = 'chat-message system-message';
            
            // Créer la structure DOM proprement sans HTML inline
            ...
            iconWrapper.className = 'welcome-icon';
            ...
            textWrapper.className = 'welcome-text';
            
            const title = document.createElement('span');
            title.className = 'welcome-text-title';
            title.textContent = '💬 Chat SEA';
            
            const subtitle = document.createElement('span');
            subtitle.className = 'welcome-text-subtitle';
            subtitle.textContent = 'Service Expert Audiovisuel';
            
            const description = document.createElement('span');
            description.className = 'welcome-text-description';
            description.textContent = 'Décrivez votre problème et notre équipe vous assistera en temps réel';
            
            // Statut
            const status = document.createElement('span');
            status.className = 'welcome-status';
            const statusDot = document.createElement('span');
            statusDot.className = 'welcome-status-dot';
            status.appendChild(statusDot);
            status.appendChild(document.createTextNode(' Technicien disponible'));
