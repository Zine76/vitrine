    ...
    try {
        ...
        function startStatusEventSource() {
            ...
            window.showTypingIndicator = function(sender = 'sea') {
                ...
                indicator.innerHTML = `
                    <div style="display: inline-flex; align-items: center; gap: 12px; background: #f3f4f6; border: 1px solid #e5e7eb; border-radius: 18px; padding: 12px 16px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; max-width: 280px; margin: 8px 0;">
                        <div style="width: 32px; height: 32px; border-radius: 50%; background: ${avatarColor}; display: flex; align-items: center; justify-content: center; color: white; font-size: 12px; font-weight: 600; flex-shrink: 0;">${senderInitials}</div>
                        <div style="display: flex; flex-direction: column; gap: 2px; flex: 1;">
                            <div style="font-weight: 600; font-size: 14px; color: #1f2937; line-height: 1.2;">${senderText}</div>
                            <div style="display: flex; align-items: center; gap: 8px; font-size: 13px; color: #6b7280; line-height: 1.2;">
