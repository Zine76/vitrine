    ...
    try {
        ...
        function openChatInterface() {
            ...
            if (messagesContainer && messagesContainer.children.length === 0) {
                // Créer un message d'accueil avec style forcé
            ...
            welcomeMessage.innerHTML = `
                <div class="system-message-content" style="
                ...
                ">
                    ...
                    "></i>
                    <div class="system-message-text" style="
                    ...
                    ">
                        <strong style="
                            ...
                            text-shadow: 0 1px 2px rgba(0, 0, 0, 0.1) !important;
                        ">Bonjour ! 👋</strong>
                        Technicien SEA à votre service<br>
                        <em style="
                            display: block !important;
