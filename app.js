...
async function startPhoneCall() {
    ...
    try {
        ...
        // 🔒 SÉCURITÉ : Créer une URL courte pour le QR code (sans exposer l'IP)
        const shortRoomId = roomData.roomId.split('-')[1]; // Prendre seulement la partie courte
        phoneJoinURL = `https://savqonnect.app/join/${shortRoomId}`;
