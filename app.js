...
if (document.querySelector('[id^="escalation_sea_"]') || document.querySelector('[id^="overlay_escalation_sea_"]')) {
    ...
    try {
        ...
        function openChatInterface() {
            ...
            // Utiliser le gestionnaire de styles s'il est disponible, sinon style par défaut
            if (window.WelcomeMessageManager && window.WelcomeMessageManager.createMessage) {
                welcomeMessage.innerHTML = window.WelcomeMessageManager.createMessage();
            } else {
                // Style par défaut si le gestionnaire n'est pas chargé
