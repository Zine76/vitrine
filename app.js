    ...
    try {
        ...
        function startChatRequestListener() {
            ...
            eventSource.onerror = function(error) {
                ...
                // ✅ CORRECTION : Ne pas reconnecter automatiquement pour éviter les boucles infinies
                // La reconnexion sera gérée par le monitoring du backend
        ...
        function startStatusEventSource() {
            ...
            statusEventSource.onerror = function(error) {
                ...
                // ✅ CORRECTION : Pas de reconnexion automatique pour éviter les boucles
