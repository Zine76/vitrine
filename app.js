...
if (document.querySelector('[id^="escalation_sea_"]') || document.querySelector('[id^="overlay_escalation_sea_"]')) {
    ...
    try {
        ...
        function openChatInterface() {
            ...
            subtitle.textContent = '• Technicien disponible';
        ...
        function adjustVitrineFont(action) {
            ...
            if (chatMessages) {
                ...
                // Forcer l'application aux messages existants
                const messageElements = chatMessages.querySelectorAll('.chat-message, .message, .system-message');
        ...
        function addChatMessage(message, type) {
            ...
            messageElement.style.fontSize = 'inherit'; // Hériter de la taille du parent
