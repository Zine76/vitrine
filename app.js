...
async function startPCCall() {
    ...
    try {
        ...
        // Utiliser les fonctions WebRTC depuis config.js si disponibles
        if (typeof CFG !== 'undefined' && CFG.createSSEConnection) {
            console.log('✅ Utilisation du système WebRTC depuis config.js');
            // TODO: Intégrer le vrai système WebRTC ici
            alert('Système WebRTC en cours d\'intégration. SAVQonnect devrait sonner.');
        } else {
            console.log('⚠️ Système WebRTC non disponible, simulation temporaire');
            alert('Système WebRTC temporairement indisponible. SAVQonnect ne sonnera pas.');
        }
