        ...
        updatePlanSection: function(roomName) {
            ...
            if (AVAILABLE_PLANS.includes(roomName)) {
                ...
                if (planLink) {
                    ...
                    switch(roomName) {
                        case 'A-1825':
                            planUrl = '\\\\index\\Donnees.01\\SAV\\Accueil\\Soutien\\Atelier\\plans\\plans_branchements\\A (Pavillon Hubert-Aquin)\\A-1825';
                            break;
                        default:
                            planUrl = `\\\\index\\Donnees.01\\SAV\\Accueil\\Soutien\\Atelier\\plans\\plans_branchements\\${roomName}`;
                    }
